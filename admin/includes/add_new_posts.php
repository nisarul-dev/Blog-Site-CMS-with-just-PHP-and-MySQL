...
<form action="posts.php?posts=add_new" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <div class="col-md-10">
            <div class="radio">
                <label>
                    <input type="radio" name="post-status" id="optionsRadios1" value="draft" checked>
                    Draft
                </label>
            </div>
            <div class="radio">
                <label>
                    <input type="radio" name="post-status" id="optionsRadios2" value="published">
                    Published
                </label>
            </div>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="post-author" name="post-author" placeholder="Post Title">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="post-tags" name="post-tags" placeholder="Post Title">
        <small class="text-danger"><?php echo isset($error['tags']) ? $error['tags'] : "" ; ?></small>
    </div>
    <div class="form-group">
        <label for="main-post-text">Write Post:</label>
        <textarea id="main-post-text" name="main-post-text" class="form-control" rows="5" placeholder="Write here..."></textarea>
